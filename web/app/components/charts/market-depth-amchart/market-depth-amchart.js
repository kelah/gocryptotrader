angular.module('goCryptoWeb.charts.market-depth-amchart', []).component('ammarketdepth', {
    templateUrl: '/components/charts/market-depth-amchart/market-depth-amchart.html',
    controller: 'AmMarketDepthController',
    controller: function($scope, $timeout, $q) {
        ...
        $scope.amChartOptions = $timeout(function() {
            return {
                ...
                categoryField: "date",
                pathToImages: '/bower_components/amstock3/amcharts/images/',
                categoryAxis: {
                    gridPosition: "start",
                    parseDates: false
                },
